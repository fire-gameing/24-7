...
If you decide to use this Bot, [check out this Github repo first](https://github.coam/SAURABH-777/music-bot/) cause this is the same exact Bot with standard Discord/Unicode Emojis, which means that you can just simply use it instantly without changing the emojis!
 ...
 **5.** start the bot with **`node index.js`**<br/>
 ...
 [![Run on Repl.it](https://repl.it/badge/github/SAURABH-777/music-bot-v2/)](https://repl.it/github/SAURABH-777/music-bot-v2/)</br>
